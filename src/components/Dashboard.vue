  ...
  <div>
    ...
    >
      ...
      >
        <template #body="{ data }">
          <img
            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACwAAAAeAQMAAABt+G7kAAAAA1BMVEVMaXFNx9g6AAAAAXRSTlMAQObYZgAAAAtJREFUeF5jGHYAAADSAAEzF5gpAAAAAElFTkSuQmCC"
      ...
      >
        <template #body="{ data }">
          <img
            src="https://primefaces.org/primevue/demo/images/avatar/amyelsner.png"
            width="30"
            style="vertical-align: middle; margin-right: 5px"
          />
